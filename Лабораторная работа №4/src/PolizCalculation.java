                ...
                if (types.get(t1.data).equals("List")) {
                    if (t2.type == TokenType.NUMBER) {
                        if (token.data.equals("add")) {
                            ...
                            stack.add(new Token(TokenType.NUMBER, (String) ((MyLinkedList) values.get(t1.data)).get(Integer.parseInt(t2.data))));
                        ...
                        if (token.data.equals("add")) {
                            ...
                            stack.add(new Token(TokenType.NUMBER, (String) ((MyLinkedList) values.get(t1.data)).get((Integer)values.get(t2.data))));
                        } else if (token.data.equals("remove")) {
                            ((MyLinkedList) values.get(t1.data)).remove((Integer)(values.get(t2.data)));
                        } else if (token.data.equals("contains")) {
                            stack.add(new Token(TokenType.BOOL, Boolean.toString(((MyLinkedList) values.get(t1.data)).contains(values.get(t2.data)))));
                        }
                    }
                }
                else if (types.get(t1.data).equals("Set")) {
                    if (t2.type == TokenType.NUMBER) {
                        ...
                        if (token.data.equals("add")) {
                            ...
                            stack.add(new Token(TokenType.BOOL, Boolean.toString(((MyHashSet) values.get(t1.data)).contains(values.get(t2.data)))));
                        }
                    }
                }
            }
